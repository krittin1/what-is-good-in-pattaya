...
Change To History Page
    ...
    Table Cell Should Contain    id: table_history    row=2    column=5    ${USER_ID}
    Table Cell Should Contain    id: table_history    row=2    column=6    ${NAME}    
    Table Cell Should Contain    id: table_history    row=2    column=8    ${MESSAGE}
